...
class Audio_function(object):
           ...
           def Speech_recognition(self,initial_lang,destination_lang): # Getting the prameter for language processing on the speech recognition 
                  lang =  initial_lang
                  ...
                  def callback(recognizer, audio,addresses,port,initial_lang):
                           # received audio data, now we'll recognize it using Google Speech Recognition
                           sock = socket.socket(socket.AF_INET,socket.SOCK_DGRAM)
                           address = addresses 
                           try:
                   
                               print("Speech Recognition thinks you said " + recognizer.recognize_google(audio,language = initial_lang)) # Setting the default language from the json file 
                               send_speech_data = {recognizer.recognize_google(audio,language = 'th'):initial_lang}  
           ...
           def Text_to_speech(self,destination_lang,speed_speak):
              ...
              for tr in count(0):   
                  ...
                  if check_int == True: 
                         ...
                         if vis_output == 1:
                                ...
                                cv2.imshow('"'+str('data_sensor')+'"',im2)
